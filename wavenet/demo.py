...
def set_args():
    ...
    parser.add_argument('--model_file', type=str, default='wn.pt', help='filename of wn')
...
if __name__ == '__main__':
    ...
    if os.path.isfile(args.model_file):
        print('Loading wn data from file: {}'.format(args.model_file))
    ...
    if args.resume_train:
        ...
        print('Saving wn data to file: {}'.format(args.model_file))
        torch.save(wave_model.state_dict(), args.model_file)

    # predict sequence with wn
    ...
    dataset.save_wav('./output.wav', y, dataloader.dataset.sample_rate)
