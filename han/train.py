...
def get_args():
    parser = argparse.ArgumentParser(
        """Implementation of the wn described in the paper: Hierarchical Attention Networks for Document Classification""")
    ...
    parser.add_argument("--train_set", type=str, default="data/amazon_review/train.csv")
    parser.add_argument("--test_set", type=str, default="data/amazon_review/test.csv")
...
def train(opt):
    ...
    # writer.add_graph(wn, torch.zeros(opt.batch_size, max_sent_length, max_word_length))
